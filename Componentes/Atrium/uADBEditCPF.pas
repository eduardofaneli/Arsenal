...
type
  ADBEditCPF = class(ADBEditInteiro)
  private
    FCPF : String;
...
procedure Register;
begin
  RegisterComponents('Atrium', [ADBEditCPF]);
end;

{ ADBEditCPF }

constructor ADBEditCPF.Create(AOwner: TComponent);
begin
  inherited;
  Self.MaxLength := 11;
...
procedure ADBEditCPF.ValidateCPF(CPF: String);
var
