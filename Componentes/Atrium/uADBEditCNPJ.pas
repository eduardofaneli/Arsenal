...
type
  ADBEditCNPJ = class(ADBEditInteiro)
  private
    FCNPJ : String;
...
procedure Register;
begin
  RegisterComponents('Atrium', [ADBEditCNPJ]);
end;

{ ADBEditCNPJ }

constructor ADBEditCNPJ.Create(AOwner: TComponent);
begin
  inherited;
  Self.MaxLength := 14;
...
procedure ADBEditCNPJ.ValidateCNPJ(CNPJ: String);
var
