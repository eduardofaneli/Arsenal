...
procedure Register;
begin
  RegisterComponents('Atrium', [ADBEdit]);
end;

{ ADBEdit }

constructor ADBEdit.Create(AOwner: TComponent);
begin
...
procedure ADBEdit.SetInvalid(Value: Boolean);
begin
  FInvalid := Value;
  if Value then
  begin
